...
class ilsvrc(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'ilsvrc_' + year + '_det_' + image_set)
        self._year = year
        ...
        self._synsets = sio.loadmat(os.path.join(self._devkit_path,
                                                 'data', 'meta_det.mat'))
        for i in xrange(200):
            self._classes = self._classes + (self._synsets['synsets'][0][i][2][0],)
            self._wnid = self._wnid + (self._synsets['synsets'][0][i][1][0],)
...
#                       'use_diff'    : False,
    ...
    def _load_image_set_index(self):
        ...
        # self._devkit_path + /ILSVRCdevkit2013/data/det_lists/val.txt
